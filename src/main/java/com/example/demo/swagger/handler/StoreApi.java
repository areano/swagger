...
public interface StoreApi {
    ...
    default ResponseEntity<Void> _deleteOrder(@Min(1L)@ApiParam(value = "ID of the order that needs to be deleted",required=true, allowableValues="") @PathVariable("orderId") Long orderId
) {
    ...
    @RequestMapping(value = "/store/order/{orderId}",
        ...
        method = RequestMethod.GET)
    default ResponseEntity<Order> _getOrderById(@Min(1L) @Max(10L) @ApiParam(value = "ID of pet that needs to be fetched",required=true, allowableValues="") @PathVariable("orderId") Long orderId
) {
